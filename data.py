...
with app.app_context():
    ...
    qca4 = QCA(student_id=student4.id, semester=1, qca_score=4.0)
    qca5 = QCA(student_id=student5.id, semester=1, qca_score=2.8)
    qca6 = QCA(student_id=student6.id, semester=1, qca_score=3.4)
    qca7 = QCA(student_id=student7.id, semester=1, qca_score=3.9)
    qca8 = QCA(student_id=student8.id, semester=1, qca_score=3.0)
    qca9 = QCA(student_id=student9.id, semester=1, qca_score=3.3)
    qca10 = QCA(student_id=student10.id, semester=1, qca_score=2.7)
    ...
    company13 = Company(name="Keepr Solutions", num_of_positions= 1)
